  ...
  return (
    <section>
      <div className="relative w-full h-[80vh] md:h-[60vh] lg:h-[90vh] bg-cover bg-center">
        ...
        <div className="absolute top-0 left-0 w-full h-full  flex flex-col justify-center items-start pl-6 md:pl-16 lg:pl-24 text-left">
          ...
          <span className="text-white md:w-2/4 w-full px-2 md:px-2 text-justify text-sm font-medium font-serif md:text-lg lg:text-xl mt-6">
            At Joyful Smiles Dental Outreaches, We believe everyone deserves
            healthy, happy Smile. Our mission is to provide access to quality
      ...
      <section className="px-8 lg:px-16 my-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 justify-center font-medium">
          <div className="bg-[#D9D9D9] py-4 px-6">
            ...
            <ul className="mt-8">
              <li className="flex items-center  space-x-2 mb-3">
                ...
                Opportunity to give back to the society and humanity at large
              </li>
              <li className="flex items-center  space-x-2 mb-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                Make a tangible difference in the lives of underserved
                individuals
              </li>
              ...
              <li className="flex items-center  space-x-2 mb-3">
                ...
                Enhance your skills and experience in community healthcare
              </li>
              <li className="flex items-center  space-x-2 mb-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                Receive a Certificate of Service, recognizing your contribution
              </li>
              <li className="flex items-center  space-x-2 mb-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="bg-[#D9D9D9] py-4 px-6">
            ...
            <h2 className="text-center text-xl my-2 font-normal font-serif">
              We are seeking volunteers in the following roles
            </h2>
            <ul className="mt-4">
              <li className="flex items-center space-x-2 mb-3">
                <svg
      ...
      <section class="bg-[#F0F0F0] px-10 lg:px-28 py-6">
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-8 mt-8">
          <div class="bg-[#ffffff] shadow-lg border-[#005963] border-2 lex flex-col justify-center items-center p-4 px-2 rounded-2xl">
            ...
            <div>
              <p>
                <span className="font-bold px-2">Location:</span>Aboru,
                Iyana-Ipaja
              </p>
              <p>
                <span className="font-bold px-2">Dates:</span>19th January 2025
              </p>
              <p>
                <span className="font-bold px-2">Time:</span>9am prompt
              </p>
            </div>
          </div>
          <div class="bg-[#ffffff] shadow-lg border-[#005963] border-2 lex flex-col justify-center items-center p-4 px-2 rounded-2xl">
            ...
            <div>
              <p>
                <span className="px-2">(1)</span>Current license/registration in
                your field
              </p>
              <p>
                <span className="px-2">(2)</span>Availability for the duration
                of the outreach
              </p>
              <p>
                <span className="px-2">(3)</span>Passion for community service
              </p>
            </div>
          </div>
          <div class="bg-[#ffffff] shadow-lg border-[#005963] border-2 flex flex-col justify-center items-center p-4 px-2 rounded-2xl">
            ...
            <div>
              <p>
                ...
                Comprehensive dental care services for underserved individuals
              </p>
              <p>
                <span className="px-2">(2)</span>Professional development
                opportunities
              </p>
              <p>
                <span className="px-2">(3)</span>A dynamic and supportive team
                environment
              </p>
            </div>
          </div>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-center mx-auto text-black font-serif text-lg mt-4 px-5 lg:px-64">
          Make a difference, one smile at a time. Bring joyful smiles and hope to our society!
        </p>
        <h2 className="flex justify-center text-black text-xs md:text-lg font-semibold font-serif pt-4 break-words text-center">
        ...
        <h2 className="flex justify-center text-black text-xs md:text-lg font-normal font-serif pt-4 break-words text-center">
          Together, let's bring joy, one smile at a time!
        </h2>
